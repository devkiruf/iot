#for i in range(5) : # if , class function : 를 쓴다
    #print(i)
...
for i in range(5):
    ...
    if num % 2 ==0 :
        ...
        print(f"{num}은 홀수입니다.")
        oddCnt=oddCnt+1
print(f"홀수개수는 {oddCnt} 개 입니다")'''

#num = [1,3,5,7,9]
#1. num.reverse()
#for i in #2. reversed(num): #3. [::-1]
    #print(i)
